...
class Cat:
    def __init__(self, animalm, animald):
        self.animalm = animalm
        self.animald = animald

    def Add(self):
        return f"This is {self.animalm} and This is {self.animald}"


class Inher(Cat):
    def __init__(self, animalm, animald, animalk):
        super().__init__(animalm, animald)
        self.__animalk = animalk

    def getk(self):
        return self.__animalk + " King"

    def setter(self, new_setter):
        self.__animalk = new_setter


Tinher = Inher("Mouse", "Duck", "Lion")
print(Tinher.Add())
print(Tinher.getk())
Tinher.setter('Sher')
print(Tinher.getk())
